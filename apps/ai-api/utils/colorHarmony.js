 ...
 *
 * Ported from client/src/utils/colorHarmony.js for server-side use
 */
 ...
 */
function generateBackdropSuggestions(colorPalette) {
 ...
 */
function getAutoBackdrop(colorPalette) {
