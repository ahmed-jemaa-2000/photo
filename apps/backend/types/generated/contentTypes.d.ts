...
export interface ApiAiGenerationAiGeneration extends Schema.CollectionType {
  collectionName: 'ai_generations';
  info: {
    singularName: 'ai-generation';
    pluralName: 'ai-generations';
    displayName: 'AI Generation';
    description: 'Tracks AI-generated images for history and gallery';
  };
  options: {
    draftAndPublish: false;
  };
...
export interface ApiCreditTransactionCreditTransaction
  ...
  info: {
    ...
    description: 'Transaction history for credit changes';
  };
  options: {
    draftAndPublish: false;
  };
  attributes: {
    ...
    balanceAfter: Attribute.Integer & Attribute.Required;
    metadata: Attribute.JSON;
    createdAt: Attribute.DateTime;
    updatedAt: Attribute.DateTime;
    createdBy: Attribute.Relation<
...
export interface ApiUserCreditUserCredit extends Schema.CollectionType {
  ...
  info: {
    ...
    description: 'Tracks credit balance for AI generation';
  };
  options: {
    draftAndPublish: false;
  };
  attributes: {
    ...
    totalPurchased: Attribute.Integer &
      Attribute.SetMinMax<
        {
          min: 0;
        },
